...
export default function OykModalDivisionCreate({ isOpen, onClose, sectorId, position }) {
  ...
  const postSubmit = async () => {
    ...
    try {
      ...
      const r = await api.post(`/world/universes/${currentUniverse.slug}/geo/divisions/create/`, formData);
      if (!r.ok) throw r;
      onClose(true);
    } catch (e) {
      setHasError({
  ...
  return (
    <OykModal title={t("Create a new division")} isOpen={isOpen} onClose={onClose}>
