...
export default function OykModalTitleEdit({ title, isOpen, onClose }) {
  ...
  const postSubmit = async () => {
    ...
    setHasError(null);
    try {
      const url = `/progress/u/${currentUniverse.slug}/titles/${title.id}/edit/`;
  ...
  useEffect(() => {
    setTitleForm({
      ...
      how_to_obtain: title.how_to_obtain,
      target: title.target,
      is_unique: title.is_unique,
  ...
  return (
    <OykModal title={t("Edit title")} isOpen={isOpen} onClose={onClose}>
